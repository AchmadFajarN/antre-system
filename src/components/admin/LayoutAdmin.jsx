  ...
  if (!isAdmin) {
    ...
    return (
      <main className="max-h-screen text-gray-800 h-screen overflow-hidden bg-gray-100 flex">
        <SidebarAdmin />
        <div className="content-stretch flex-4 pt-4 px-2 overflow-y-scroll overflow-x-hidden mb-8">
          <div className="w-full bg-white shadow-md p-4 rounded-md flex justify-between items-center">
            <h1 className="font-semibold md:text-xl uppercase">Admin Dashboard</h1>
            <Bell />
          </div>
          <Outlet />
        </div>
